            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('teacher.shift.index')}}" class="text-decoration-none">Timing</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Edit Timing</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="border border-3 p-4 rounded">
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="row g-3">
                                <!-- Restaurant Name -->
                                <form method="POST" action="{{route('teacher.shift.update',$shift->id)}}">
                                    @csrf
                                    <div class="col-md-12 mb-3">
                                        <label for="shift_name" class="form-label mb-2">Select Timing</label>
                                        <select name="shift_name" id="shift_name" class="form-control @error('shift_name') is-invalid @enderror">
