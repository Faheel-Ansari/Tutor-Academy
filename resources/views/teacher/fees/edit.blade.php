                ...
                <div class="border border-3 p-4 rounded">
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="row g-3">
                                <!-- Restaurant Name -->
                                <form method="POST" action="{{route('teacher.fees.update',$fee->id)}}">
                                    @csrf
                                    <div class="col-md-12 mb-3">
                                        <label for="fee" class="form-label mb-2">Your Fee</label>
                                        <input type="number" value="{{$fee->fee}}" name="fee" id="fee" class="form-control @error('fee') is-invalid @enderror">
