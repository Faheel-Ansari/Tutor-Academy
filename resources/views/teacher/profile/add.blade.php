                            ...
                            <div class="row g-3">
                                ...
                                <form method="POST" action="{{route('teacher.profile.store')}}">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="tel" name="phone_no" id="phone_no" class="form-control" placeholder="Enter Phone Number">
                                        <span class="text-danger">{{ $errors->first('phone_no') }}</span>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <label for="cnic" class="form-label mb-2">CNIC Number</label>
                                        <input type="text" name="cnic" id="cnic" class="form-control" placeholder="Enter CNIC Number">
                                        <span class="text-danger">{{ $errors->first('cnic') }}</span>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <label for="qualification" class="form-label mb-2">Qualification</label>
                                        <input type="text" name="qualification" id="qualification" class="form-control" placeholder="Enter Your Qualification">
                                        <span class="text-danger">{{ $errors->first('qualification') }}</span>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <label for="experience" class="form-label mb-2">Experience in years</label>
                                        <input type="number" name="experience" id="experience" class="form-control" placeholder="Enter Your Experience">
