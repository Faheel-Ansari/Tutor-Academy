                ...
                <div class="border border-3 p-4 rounded">
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="row g-3">
                                <!-- Restaurant Name -->
                                <form method="POST" action="{{route('teacher.grade.update',$selectedgrade->id)}}">
                                    @csrf
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <select name="grade" id="grade" class="form-control @error('grade') is-invalid @enderror">
                                            ...
                                            <option value="{{$grade->grade}}" {{$grade->grade == $selectedgrade->class ? 'selected' : ''}}>{{$grade->grade}}</option>
                                            @endforeach
                                        </select>
