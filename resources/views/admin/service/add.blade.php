                            ...
                            <div class="row g-3">
                                ...
                                <form method="POST" action="{{route('admin.service.store')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" name="servicehead" id="servicehead" class="form-control @error('servicehead') is-invalid @enderror" value="{{old('servicehead')}}">
                                        <span class="text-danger">{{ $errors->first('servicehead') }}</span>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <label for="servicepara" class="form-label mb-2">Service Paragraph</label>
                                        <input type="text" name="servicepara" id="servicepara" class="form-control @error('servicepara') is-invalid @enderror" value="{{old('servicepara')}}">
