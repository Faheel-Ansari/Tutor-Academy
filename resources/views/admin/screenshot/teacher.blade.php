                        ...
                        <div class="table-responsive">
                            <table id="studentDetails" class="table mb-0">
                                ...
                                <tbody class="text-center">
                                    ...
                                    @php
                                        $teacher = TeacherProfile::where('role_id',$screenshot->teacher_id)->first();
                                        $teacherFee = TeacherFee::where('role_id',$screenshot->teacher_id)->first();
                                    @endphp
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle">
                                            @if($screenshot->pay_approval == '0')
                                            <a href="{{route('admin.teacher.payment.approve',$screenshot->id)}}" class="btn btn-success">Approve</a>
                                            @else
