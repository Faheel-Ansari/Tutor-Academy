                            ...
                            <div class="row g-3">
                                ...
                                <form method="POST" action="{{route('admin.about.update',$about->id)}}" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" name="abouthead" id="abouthead" class="form-control @error('abouthead') is-invalid @enderror" value="{{$about->abouthead}}">
                                        <span class="text-danger">{{ $errors->first('abouthead') }}</span>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <label for="aboutpara" class="form-label mb-2">About Paragraph</label>
                                        <textarea rows="10" name="aboutpara" id="aboutpara" class="form-control @error('aboutpara') is-invalid @enderror">{{$about->aboutpara}}</textarea>
