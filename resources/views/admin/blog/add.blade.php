                            ...
                            <div class="row g-3">
                                ...
                                <form method="POST" action="{{route('admin.blog.store')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" name="img_title" id="img_title" class="form-control @error('img_title') is-invalid @enderror" value="{{old('img_title')}}" placeholder="eg: Online Learning">
                                        <span class="text-danger">{{ $errors->first('img_title') }}</span>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <label for="blog_title" class="form-label mb-2">Blog Title</label>
                                        <input type="text" name="blog_title" id="blog_title" class="form-control @error('blog_title') is-invalid @enderror" value="{{old('blog_title')}}" placeholder="Blog Title here..">
                                        <span class="text-danger">{{ $errors->first('blog_title') }}</span>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <label for="blog_para" class="form-label mb-2">Blog Paragraph</label>
                                        <textarea name="blog_para" id="blog_para" class="form-control @error('blog_para') is-invalid @enderror" placeholder="Blog Paragraph here..">{{old('blog_para')}}</textarea>
