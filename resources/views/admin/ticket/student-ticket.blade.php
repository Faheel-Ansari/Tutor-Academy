                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Student Tickets</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12 col-lg-12 d-flex">
                <div class="card radius-10 w-100">
                    <div class="card-body">
                        @if($studentTickets != null && $studentTickets->count() > 0 )
                        <div class="table-responsive">
                            <table id="studentDetails" class="table table-striped" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    @php
                                    $student = User::where('id',$ticket->student_id)->first()
                                    @endphp
                                    <tr class="text-center">
