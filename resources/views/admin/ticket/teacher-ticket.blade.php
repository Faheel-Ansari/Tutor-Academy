                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Teacher Tickets</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12 col-lg-12 d-flex">
                <div class="card radius-10 w-100">
                    <div class="card-body">
                        @if($teacherTickets != null && $teacherTickets->count() > 0 )
                        <div class="table-responsive">
                            <table id="studentDetails" class="table table-striped" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($teacherTickets as $ticket)
                                    @php
                                    $teacher = User::where('id',$ticket->teacher_id)->first()
                                    @endphp
                                    <tr class="text-center">
                                        ...
                                        <td style="vertical-align: middle;" class="text-primary">{{ $ticket->concern }}</td>
                                        ...
                                        @else
                                        <td style="vertical-align: middle"><a href="{{route('admin.ticket.seen',$ticket->id)}}" class="btn btn-warning">Pending</a></td>
                                        @endif
                                    </tr>
                                    @endforeach
                                </tbody>
